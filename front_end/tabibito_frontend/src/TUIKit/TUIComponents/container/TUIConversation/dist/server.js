...
var TUIConversationServer = /** @class */ (function (_super) {
    ...
    TUIConversationServer.prototype.updateStore = function (newValue, oldValue) {
        ...
        (_b = newValue === null || newValue === void 0 ? void 0 : newValue.conversationList) === null || _b === void 0 ? void 0 : _b.filter(function (item) {
            var _a, _b;
            if ((_a = item === null || item === void 0 ? void 0 : item.userProfile) === null || _a === void 0 ? void 0 : _a.userID) {
                _this.currentStore.userIDList.add((_b = item === null || item === void 0 ? void 0 : item.userProfile) === null || _b === void 0 ? void 0 : _b.userID);
            }
        });
        this.currentStore.userStatusList = (_c = this.TUICore.TUIServer.TUIContact.currentStore) === null || _c === void 0 ? void 0 : _c.userStatusList;
    };
    /**
     * 处理异步函数
     *
                ...
                return [2 /*return*/, this.handlePromiseCallback(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, this.TUICore.tim
                                            .getConversationList()
                                            .then(function (res) {
                                            console.warn(1111111, res.data);
                                            console.warn(1111111, _this.TUICore.tim.getTotalUnreadMessageCount());
                                        })];
                                case 1:
                                    imResponse = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        this.currentStore.userStatusList = (_a = this.TUICore.TUIServer.TUIContact.currentStore) === null || _a === void 0 ? void 0 : _a.userStatusList;
