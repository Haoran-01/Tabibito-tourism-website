            ...
            <div class="block_sub_wrap">
              <div class="row block_content">
                <div class="col-auto">
                  ...
                  <div class="block_money">${{ earns.month_pending.toFixed(2) }}</div>
            ...
            <div class="block_sub_wrap">
              <div class="row block_content">
                <div class="col-auto">
                  ...
                  <div class="block_money">${{ earns.month_earning.toFixed(2) }}</div>
            ...
            <div class="block_sub_wrap">
              <div class="row block_content">
                <div class="col-auto">
                  ...
                  <div class="block_money">${{ earns.quarterly_pending.toFixed(2) }}</div>
<!--                  <div class="block_total">Total pending</div>-->
                </div>
            ...
            <div class="block_sub_wrap">
              <div class="row block_content">
                <div class="col-auto">
                  ...
                  <div class="block_money">${{ earns.quarterly_earning.toFixed(2) }}</div>
